...
int main() {
    ...
    Date fecha {07,13,2020};
    Date cumpleanios {07,02,1984};
    if (fecha.getMonth()==cumpleanios.getMonth()){
        salariedEmployee.monthlySalary+= 100;
    }
    ...
    // create and initialize vector of three base-class pointers
        vector<Employee *> employees{&salariedEmployee};
