 ...
 const string& ssn, Date& cumpleanios)
 : firstName(first), lastName(last), socialSecurityNumber(ssn), birthDate(cumpleanios) {}
 // set first name
 ...
 void Employee::setBirthDate (Date& cumpleanios){
